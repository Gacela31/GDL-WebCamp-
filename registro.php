                    ...
                    <div class="caja">
                        <div class="extras">
                            ...
                            <div class="orden">
                                ...
                                <input type="number" min="0" id="etiqueta" size="3" name="pedido_extra[etiqueta][cantidad]" placeholder="0">
                                <input type="hidden" value="2" name="pedido_extra[etiqueta][precio]">
                            </div> <!--orden-->
                            <div class="orden">
                                <label for="regalo">Seleccione un regalo</label>
                                <select id="regalo" name="regalo" required>
                                    <option value="">-Seleccione un regalo--</option>
                                    <option value="2">Etiquetas</option> <!--el value debe coincidir con el ID de mi DB-->
